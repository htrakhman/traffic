...
class Scraper(BasePermitScraper):
    STATE = 'KY'
    STATE_NAME = 'Kentucky'
    SOURCES: list[dict[str, Any]] = [{'key': 'KY_Louisville',
      'name': 'Louisville Permits',
      'kind': 'unimplemented',
      'url': 'https://louisvilleky.gov/government/develop-louisville/permits-licensing',
