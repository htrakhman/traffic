"""
Texas DOT bid scraper.

Source pages
------------
  Lettings: https://www.txdot.gov/business/letting-bids/upcoming-letting.html
  Awards:   https://www.txdot.gov/business/letting-bids/recent-letting-results.html
...
class Scraper(StateScraper):
    state_code = "TX"
    state_name = "Texas"
    lettings_url = "https://www.txdot.gov/business/letting-bids/upcoming-letting.html"
    awards_url = "https://www.txdot.gov/business/letting-bids/recent-letting-results.html"
