"""
Vermont DOT bid scraper.

Source pages
------------
  Lettings: https://vtrans.vermont.gov/business/contract-admin/lettings
  Awards:   https://vtrans.vermont.gov/business/contract-admin/awards
...
class Scraper(StateScraper):
    state_code = "VT"
    state_name = "Vermont"
    lettings_url = "https://vtrans.vermont.gov/business/contract-admin/lettings"
    awards_url = "https://vtrans.vermont.gov/business/contract-admin/awards"
