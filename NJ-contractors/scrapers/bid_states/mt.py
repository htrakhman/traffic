"""
Montana DOT bid scraper.

Source pages
------------
  Lettings: https://www.mdt.mt.gov/business/contracting/letting.aspx
  Awards:   https://www.mdt.mt.gov/business/contracting/awards.aspx
...
class Scraper(StateScraper):
    state_code = "MT"
    state_name = "Montana"
    lettings_url = "https://www.mdt.mt.gov/business/contracting/letting.aspx"
    awards_url = "https://www.mdt.mt.gov/business/contracting/awards.aspx"
