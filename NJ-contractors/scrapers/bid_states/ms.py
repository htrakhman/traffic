"""
Mississippi DOT bid scraper.

Source pages
------------
  Lettings: https://mdot.ms.gov/portal/contract_administration.aspx
  Awards:   https://mdot.ms.gov/portal/bid_results.aspx
...
class Scraper(StateScraper):
    ...
    lettings_url = "https://mdot.ms.gov/portal/contract_administration.aspx"
    awards_url = "https://mdot.ms.gov/portal/bid_results.aspx"
