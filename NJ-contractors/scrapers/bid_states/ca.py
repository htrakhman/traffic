"""
California DOT bid scraper.

Source pages
------------
  Lettings: https://dot.ca.gov/programs/construction/contract-awards-services/upcoming-and-current-projects
  Awards:   https://dot.ca.gov/programs/construction/contract-awards-services/awarded-contracts
...
class Scraper(StateScraper):
    ...
    lettings_url = "https://dot.ca.gov/programs/construction/contract-awards-services/upcoming-and-current-projects"
    awards_url = "https://dot.ca.gov/programs/construction/contract-awards-services/awarded-contracts"
