"""
New York DOT bid scraper.

Source pages
------------
  Lettings: https://www.dot.ny.gov/doing-business/opportunities/const-letting
  Awards:   https://www.dot.ny.gov/doing-business/opportunities/const-awards
...
class Scraper(StateScraper):
    state_code = "NY"
    state_name = "New York"
    lettings_url = "https://www.dot.ny.gov/doing-business/opportunities/const-letting"
    awards_url = "https://www.dot.ny.gov/doing-business/opportunities/const-awards"
