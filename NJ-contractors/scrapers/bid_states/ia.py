"""
Iowa DOT bid scraper.

Source pages
------------
  Lettings: https://iowadot.gov/contracts/letting-information
  Awards:   https://iowadot.gov/contracts/bid-results
...
class Scraper(StateScraper):
    state_code = "IA"
    state_name = "Iowa"
    lettings_url = "https://iowadot.gov/contracts/letting-information"
    awards_url = "https://iowadot.gov/contracts/bid-results"
