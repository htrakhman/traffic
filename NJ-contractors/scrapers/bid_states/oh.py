"""
Ohio DOT bid scraper.

Source pages
------------
  Lettings: https://www.transportation.ohio.gov/working/contractors/letting
  Awards:   https://www.transportation.ohio.gov/working/contractors/letting/award-results
...
class Scraper(StateScraper):
    state_code = "OH"
    state_name = "Ohio"
    lettings_url = "https://www.transportation.ohio.gov/working/contractors/letting"
    awards_url = "https://www.transportation.ohio.gov/working/contractors/letting/award-results"
