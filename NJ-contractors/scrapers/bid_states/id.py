"""
Idaho DOT bid scraper.

Source pages
------------
  Lettings: https://itd.idaho.gov/business/letting/
  Awards:   https://itd.idaho.gov/business/letting/bid-results/
...
class Scraper(StateScraper):
    state_code = "ID"
    state_name = "Idaho"
    lettings_url = "https://itd.idaho.gov/business/letting/"
    awards_url = "https://itd.idaho.gov/business/letting/bid-results/"
