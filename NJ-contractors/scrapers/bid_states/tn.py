"""
Tennessee DOT bid scraper.

Source pages
------------
  Lettings: https://www.tn.gov/tdot/contracts/upcoming-tdot-letting.html
  Awards:   https://www.tn.gov/tdot/contracts/awarded-contracts.html
...
class Scraper(StateScraper):
    ...
    lettings_url = "https://www.tn.gov/tdot/contracts/upcoming-tdot-letting.html"
    awards_url = "https://www.tn.gov/tdot/contracts/awarded-contracts.html"
