"""
Oklahoma DOT bid scraper.

Source pages
------------
  Lettings: https://oklahoma.gov/odot/business-center/contracts.html
  Awards:   https://oklahoma.gov/odot/business-center/contracts/awards.html
...
class Scraper(StateScraper):
    state_code = "OK"
    state_name = "Oklahoma"
    lettings_url = "https://oklahoma.gov/odot/business-center/contracts.html"
    awards_url = "https://oklahoma.gov/odot/business-center/contracts/awards.html"
