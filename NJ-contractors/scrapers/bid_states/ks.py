"""
Kansas DOT bid scraper.

Source pages
------------
  Lettings: https://www.ksdot.gov/bureaus/burContServ/lettings.asp
  Awards:   https://www.ksdot.gov/bureaus/burContServ/awards.asp
...
class Scraper(StateScraper):
    state_code = "KS"
    state_name = "Kansas"
    lettings_url = "https://www.ksdot.gov/bureaus/burContServ/lettings.asp"
    awards_url = "https://www.ksdot.gov/bureaus/burContServ/awards.asp"
