"""
Arkansas DOT bid scraper.

Source pages
------------
  Lettings: https://www.ardot.gov/divisions/construction/letting-information/
  Awards:   https://www.ardot.gov/divisions/construction/bid-results/
...
class Scraper(StateScraper):
    state_code = "AR"
    state_name = "Arkansas"
    lettings_url = "https://www.ardot.gov/divisions/construction/letting-information/"
    awards_url = "https://www.ardot.gov/divisions/construction/bid-results/"
