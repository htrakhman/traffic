"""
Alabama DOT bid scraper.

Source pages
------------
  Lettings: https://www.dot.state.al.us/conweb/bid_information.htm
  Awards:   https://www.dot.state.al.us/conweb/bid_results.htm
...
class Scraper(StateScraper):
    state_code = "AL"
    state_name = "Alabama"
    lettings_url = "https://www.dot.state.al.us/conweb/bid_information.htm"
    awards_url = "https://www.dot.state.al.us/conweb/bid_results.htm"
