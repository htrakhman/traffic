"""
Colorado DOT bid scraper.

Source pages
------------
  Lettings: https://www.codot.gov/business/bidding/bid-lettings
  Awards:   https://www.codot.gov/business/bidding/bid-results
...
class Scraper(StateScraper):
    state_code = "CO"
    state_name = "Colorado"
    lettings_url = "https://www.codot.gov/business/bidding/bid-lettings"
    awards_url = "https://www.codot.gov/business/bidding/bid-results"
