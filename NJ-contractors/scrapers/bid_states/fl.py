"""
Florida DOT bid scraper.

Source pages
------------
  Lettings: https://www.fdot.gov/construction/lettings/lettings.shtm
  Awards:   https://www.fdot.gov/construction/lettings/awards.shtm
...
class Scraper(StateScraper):
    state_code = "FL"
    state_name = "Florida"
    lettings_url = "https://www.fdot.gov/construction/lettings/lettings.shtm"
    awards_url = "https://www.fdot.gov/construction/lettings/awards.shtm"
