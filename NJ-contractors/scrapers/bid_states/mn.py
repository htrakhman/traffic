"""
Minnesota DOT bid scraper.

Source pages
------------
  Lettings: https://www.dot.state.mn.us/bidlet/lettings.html
  Awards:   https://www.dot.state.mn.us/bidlet/abstracts.html
...
class Scraper(StateScraper):
    ...
    lettings_url = "https://www.dot.state.mn.us/bidlet/lettings.html"
    awards_url = "https://www.dot.state.mn.us/bidlet/abstracts.html"
