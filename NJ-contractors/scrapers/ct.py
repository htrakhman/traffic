...
class Scraper(BasePermitScraper):
    ...
    SOURCES: list[dict[str, Any]] = [{'key': 'CT_Hartford',
      'name': 'Hartford Permits',
      'kind': 'unimplemented',
      'url': 'https://www.hartford.gov/government/departments/development-services',
